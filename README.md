...
- **Randomize button** that generates valid random rules (auto-rerolls if branch count is < 30 or > 3000, or produces 0 branches)
...
- **Debug visualization** with translucent wireframe collision shapes, toggleable at runtime
- **Auto-framing camera** that zooms to fit the full tree after randomization or parameter changes
